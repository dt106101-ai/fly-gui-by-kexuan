...
game:GetService("StarterGui"):SetCore("SendNotification", {
    Title = "FLY GUI V5";
    Text = "this script was made by ycarofranca23 | CapsLock to toggle fly";
...
local function toggleFly()
    if nowe == true then
        ...
        nowe = true
        -- 原飛行邏輯（tpwalking + BodyVelocity/BodyGyro）
        for i = 1, speeds do
            spawn(function()
